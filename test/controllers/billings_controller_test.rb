...
class BillingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create billing" do
    assert_difference('Billing.count') do
      post billings_url, params: { billing: { balance: @billing.balance, branch_id: @billing.branch_id, paid: @billing.paid, total: @billing.total } }
    end
  ...
  test "should update billing" do
    patch billing_url(@billing), params: { billing: { balance: @billing.balance, branch_id: @billing.branch_id, paid: @billing.paid, total: @billing.total } }
